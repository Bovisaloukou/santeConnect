...
export default function ResetPasswordForm() {
  ...
  useEffect(() => {
    if (!token) {
      setErrors({ general: "Token de réinitialisation manquant ou invalide. Veuillez vérifier le lien." });
    }
  }, [token]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!token) {
      setErrors({ general: "Token de réinitialisation manquant. Impossible de soumettre." });
      return;
    }
    ...
    <div className="w-full max-w-md">
      <Card>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={isLoading || (!token && !errors.general)}
          ...
          <CardFooter>
            <Button type="submit" className="w-full" disabled={isLoading || (!token && !errors.general) || !!errors.general && !isSuccess}>
